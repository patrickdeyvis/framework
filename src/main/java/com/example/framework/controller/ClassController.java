package com.example.framework.controller; // Declaração do pacote onde este controlador está localizado.
...
import com.example.framework.model.Class; // Importa a classe de modelo Class.
import com.example.framework.repository.ClassRepository; // Importa o repositório de classes.
